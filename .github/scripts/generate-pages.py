...
def generate_dev():
    ...
    server_rows = []
    for label, key in [("S3 useDirectStorageUrls=false", "s3_false"), ("S3 useDirectStorageUrls=true", "s3_true"), ("S3 s3ForcePathStyle=true", "s3_path_style"), ("S3 AWS KMS", "s3_kms"), ("Virtual Path", "vpath"), ("ActiveMQ Artemis", "amqp_artemis"), ("ActiveMQ Classic", "amqp_classic")]:
